...
const hasPercent = (value: any) => {
  return typeof value === 'string' && value.includes('%');
};

const CustomSvgImage = (props: props) => (
  <View
    style={[
      props.style,
      {
        width: hasPercent(getWidth(props)) ? '100%' : props.width,
        height: hasPercent(getHeight(props)) ? '100%' : props.height,
      },
      style.removePadding,
      style.removeMargin,
    ]}
